    ...
    <div>
      <div className="flex mt-14 p-2 sm:m-0 w-[85vw]  flex-col  justify-between gap-6 ">
        ...
        >
          ...
          <div className="flex flex-row items-center gap-2">
            <svg id="c#" className="size-12" viewBox="0 0 128 128">
              <path
                fill="#9B4F96"
                d="M115.4 30.7L67.1 2.9c-.8-.5-1.9-.7-3.1-.7-1.2 0-2.3.3-3.1.7l-48 27.9c-1.7 1-2.9 3.5-2.9 5.4v55.7c0 1.1.2 2.4 1 3.5l106.8-62c-.6-1.2-1.5-2.1-2.4-2.7z"
              ></path>
          ...
          <div className="flex flex-row items-center gap-2">
            <svg id="python" viewBox="0 0 128 128" className="inline size-12">
              <linearGradient
          ...
          <div className="flex flex-row items-center gap-2">
            <svg id="java" viewBox="0 0 128 128" className="inline size-12">
              <path
                fill="#0074BD"
        ...
        <h3 className="text-center font-Righteous text-xl">
          <u>Web Languages</u>{" "}
        </h3>
        <div
          id="row2"
        ...
        >
          ...
          <div className="flex flex-row items-center gap-2">
            <svg id="css" viewBox="0 0 128 128" className="inline size-12">
              <path
                fill="#1572B6"
          ...
          <div className="flex flex-row items-center gap-2">
            <svg id="js" viewBox="0 0 128 128" className="inline size-12">
              <path
                fill="#F0DB4F"
          ...
          <div className="flex flex-row items-center gap-2">
            <svg id="tailwind" viewBox="0 0 128 128" className="inline size-12">
              <path
          ...
          <div className="flex flex-row items-center gap-2">
            <svg id="jquery" viewBox="0 0 128 128" className="inline size-12">
              <path
                fill="#0868AC"
        ...
        >
          ...
          <div className="flex flex-row items-center justify-center gap-2">
            <svg id="sql-lite" viewBox="0 0 128 128" className="inline size-12">
              <defs>
                <linearGradient
        ...
        >
          ...
          <div className="flex flex-row items-center gap-2">
            <svg id="React" viewBox="0 0 128 128" className="inline size-12">
              <g fill="#61DAFB">
