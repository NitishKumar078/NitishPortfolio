    ...
    section: [
      {
        ...
        achievements: [
          "development of web application performance and scaling its performance",
          "monitoring user actions and managing for user experience without having any human intervention",
        ],
      },
    ],
  },
