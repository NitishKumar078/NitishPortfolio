...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative h-40 w-36 overflow-hidden rounded-xl border p-4",
        // light styles
...
export function Skills() {
  return (
    <div className="bg-background relative flex h-[600px] w-[80vw] flex-row items-center justify-between overflow-hidden rounded-lg border sm:w-[50vw] md:shadow-xl">
