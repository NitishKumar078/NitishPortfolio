...
const SkillCard = ({
  ...
  return (
    <div
      className={cn(
        "relative h-24 w-32 cursor-pointer overflow-hidden rounded-xl border p-4 transition-all duration-300",
...
export function Skills() {
  ...
  return (
    <div className="relative flex h-[400px] w-[80vw] flex-row items-center justify-between gap-6 overflow-hidden rounded-lg border bg-background sm:w-[60vw] md:shadow-xl">
